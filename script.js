    ...
    if (contactForm) {
        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('required') && value === '') {
                isValid = false;
                errorMessage = isRtl ? 'هذا الحقل مطلوب' : 'This field is required';
            } else if (value !== '') {
                if (type === 'email') {
                    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                    if (!emailRegex.test(value)) {
                        isValid = false;
                        errorMessage = isRtl ? 'يرجى إدخال بريد إلكتروني صحيح' : 'Please enter a valid email';
                    }
                }
        ...
        contactForm.addEventListener('submit', function (event) {
            ...
            if (allValid) {
                const isRtl = document.dir === 'rtl';
                const successMessage = isRtl ? 'تم إرسال النموذج بنجاح!' : 'Form submitted successfully!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bc33e551-727e-4570-8b91-51f06b8e51fe',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bc33e551-727e-4570-8b91-51f06b8e51fe';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bc33e551-727e-4570-8b91-51f06b8e51fe';
